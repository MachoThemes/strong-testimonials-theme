				...
				<div class="row">
					<div class="col-xs-12 col-sm-6">
						<div class="stats-section__stat mb-3">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/installations.svg">
					...
					<div class="col-xs-12 col-sm-6">
						<div class="stats-section__stat mb-3">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/downloads.svg" width="40">
					...
					<div class="col-xs-12 col-sm-6">
						<div class="stats-section__stat mb-3">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/ratings.svg" width="40">
					...
					<div class="col-xs-12 col-sm-6">
						<div class="stats-section__stat mb-3">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/services/service-3.svg" width="40">
							<h6 class="mb-0">9</h6>
