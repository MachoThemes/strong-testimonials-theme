		...
		<div data-element="fields" data-stacked="true" class="seva-fields formkit-fields">
			...
			<p class="formkit-field" style="font-size:14px; color: #ababb3;">
				<input id="gdpr-confirm" type="checkbox" value="false" required>
   				<label for="gdpr-confirm">I hereby confirm that I would like Strong Testimonials to deliver more information about their products, WordPress news and more to me by email</label>
			</p>
