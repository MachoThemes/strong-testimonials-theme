		...
		<div class="row align-items-center">
			<div class="col-lg-6 order-lg-1">
				<div class="illustration float-left mb-3 mb-lg-0">
					<img src="<?php echo ANTREAS_ASSETS_IMG; ?>/illustration-9.svg"/>
				</div><!-- illustration -->
			</div>
		...
		<div class="row align-items-center mt-5">
			<div class="col-lg-6">
				<div class="illustration mb-3 mb-lg-0 float-right">
					<img src="<?php echo ANTREAS_ASSETS_IMG; ?>/illustration-10.svg"/>
				</div><!-- illustration -->
			</div>
			<div class="col-lg-6 px-5">
				...
				<ul class="list--checkmark">
					...
					<li>Select the plugin zip file (strong-testimonials.x.x.x.zip) from your computer then click the <strong>Install Now</strong> button.</li>
